...
public class Cmdhmstore extends BaseCommand {
    ...
    public void run(final CommandSender sender, Command cmd, String label, String[] args) {
        ...
        if (args.length > 2 && args[0].equalsIgnoreCase("set")) {
            ...
            sender.sendMessage(Language.getMessagePlaceholderReplace("commandHmstoreSet", true, "%PREFIX%", "Hinweis",
            ...
            try {
                ...
                sender.sendMessage(Language.getMessagePlaceholderReplace("commandHmstoreSetError", true, "%PREFIX%", "Hinweis"));
                return;
            }
            ...
            sender.sendMessage(Language.getMessagePlaceholderReplace("commandHmstoreGet", true, "%PREFIX%", "Hinweis",
            ...
            sender.sendMessage(Language.getMessagePlaceholderReplace("commandHmstoreRemove", true, "%PREFIX%", "Hinweis",
                    "%PATH%", path));
    ...
    private void showUsage(CommandSender sender) {
        sender.sendMessage(Language.getMessagePlaceholderReplace("commandHmstoreUsage", true, "%PREFIX%", "Hinweis"));
    }
